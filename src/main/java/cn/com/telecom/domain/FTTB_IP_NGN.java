...
@Entity
@Table(name = "FTTB_IP_NGN")
public class FTTB_IP_NGN extends BaseEntity implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8816423668644300304L;
	/**
	 * 
	 */
	@Column(name="区域")
